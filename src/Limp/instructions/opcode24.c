...
// MVRSE
void LIIsaDtb_opcode24_func00(LCpu *m_cpu){
	m_cpu->regs.u[m_cpu->args.regd+0x8] = m_cpu->regs.u[m_cpu->args.regb];
}

// MVRES
void LIIsaDtb_opcode24_func01(LCpu *m_cpu){
	m_cpu->regs.u[m_cpu->args.regd] = m_cpu->regs.u[m_cpu->args.regb+0x8];
}


extern void (*LIIsaDtb_opcode24[64])(LCpu *m_cpu) = {
	[0x00] = LIIsaDtb_opcode24_func00,
	[0x01] = LIIsaDtb_opcode24_func01,
